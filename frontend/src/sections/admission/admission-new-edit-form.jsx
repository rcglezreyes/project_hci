...
export function AdmissionNewEditForm({ currentAdmission }) {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      await axios.post(
        paths.backend.api.main.admission.create,
        {
          ...data,
        ...
        <Grid xs={12} md={12}>
          <Card sx={{ p: 3 }}>
            ...
            >
              ...
              <Box
                sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', gap: 3 }}
              >
                <Controller
                  name="isSurgical"
                  control={control}
                  ...
                  render={({ field: { onChange } }) => (
                    <Field.Switch
                      ...
                      label={
                        <Typography variant="subtitle2" sx={{ mb: 0.5, color: 'text.disabled' }}>
                          Is Surgical?
                        </Typography>
                      }
