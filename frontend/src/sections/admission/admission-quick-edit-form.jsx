        ...
        <DialogContent>
            <Box sx={{
              ...
              <Alert variant="outlined" severity="info">
                PATIENT:{' '}
                <b>
                  {currentAdmission?.patient?.user?.firstName} {currentAdmission?.patient?.user?.lastName}
                </b>
              </Alert>
                <Alert variant="outlined" severity="info">
                    MEDICAL STAFF:{' '}
                    <b>
                        {currentAdmission?.medicalStaff?.user?.firstName} {currentAdmission?.medicalStaff?.user?.lastName}
                    </b>
                </Alert>
            </Box>
