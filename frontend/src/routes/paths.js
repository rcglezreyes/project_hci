...
export const paths = {
  ...
  dashboard: {
    ...
    medicalStaff: {
      root: `${ROOTS.DASHBOARD}/medicalStaff`,
      list: `${ROOTS.DASHBOARD}/medicalStaff/list`,
      new: `${ROOTS.DASHBOARD}/medicalStaff/new`,
      details: (id) => `${ROOTS.DASHBOARD}/medicalStaff/${id}`,
      edit: (id) => `${ROOTS.DASHBOARD}/medicalStaff/${id}/edit`,
    },
  },
  backend: {
    api: {
    ...
    websocket: {
      main: {
        departments: `${CONSTANTS.websocketProtocol}://${CONSTANTS.apiHost}/api/main/ws/departments/`,
        disabilities: `${CONSTANTS.websocketProtocol}://${CONSTANTS.apiHost}/api/main/ws/disabilities/`,
        specialties: `${CONSTANTS.websocketProtocol}://${CONSTANTS.apiHost}/api/main/ws/specialties/`,
        rooms: `${CONSTANTS.websocketProtocol}://${CONSTANTS.apiHost}/api/main/ws/rooms/`,
        diagnoses: `${CONSTANTS.websocketProtocol}://${CONSTANTS.apiHost}/api/main/ws/diagnoses/`,
        patients: `${CONSTANTS.websocketProtocol}://${CONSTANTS.apiHost}/api/main/ws/patients/`,
        admissions: `${CONSTANTS.websocketProtocol}://${CONSTANTS.apiHost}/api/main/ws/admissions/`,
        medicalStaff: `${CONSTANTS.websocketProtocol}://${CONSTANTS.apiHost}/api/main/ws/medical-staff/`,
        notifications: `${CONSTANTS.websocketProtocol}://${CONSTANTS.apiHost}/api/main/ws/notifications/`,
        tracks: `${CONSTANTS.websocketProtocol}://${CONSTANTS.apiHost}/api/main/ws/tracks/`,
      },
      users: {
        userRoles: `${CONSTANTS.websocketProtocol}://${CONSTANTS.apiHost}/api/users/ws/user-roles/`,
        users: `${CONSTANTS.websocketProtocol}://${CONSTANTS.apiHost}/api/users/ws/users/`,
      },
    },
    graphql: {
      main: {
